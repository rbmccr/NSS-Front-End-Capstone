...
const feedback = {
  ...
  buildLevels(feedbackResults) {
    ...
    const item7_child = (0, _elementBuilder.default)("p", {
      "class": "heading"
    }, "Goals from Behind & Beyond Midfield");
    ...
    const columns3_shotDetails = (0, _elementBuilder.default)("div", {
      "id": "feedback-3",
      "class": "columns"
    }, null, item7, item8, item9); // remove old content if it's already on page
