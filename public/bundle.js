...
const loginOrSignup = {
  ...
  signupForm() {
    ...
    const signupConfirmField = (0, _elementBuilder.default)("div", {
      "class": "field"
    }, null, signupConfirmLabel, signupConfirmControl); // confirm password input with icon
    ...
    const signupProfilePicField = (0, _elementBuilder.default)("div", {
      "class": "field"
    }, null, signupProfilePicLabel, signupProfilePicControl); // form

    const signupForm = (0, _elementBuilder.default)("form", {
      "id": "signupForm",
      "class": "box",
      "style": "min-width:20%"
    }, null, signupNameField, signupUsernameField, signupEmailField, signupPasswordField, signupConfirmField, signupProfilePicField, signupBtnControl);
    webpage.innerHTML = null;
    webpage.style.display = "flex";
    webpage.style.justifyContent = "center";
    webpage.style.alignItems = "center";
