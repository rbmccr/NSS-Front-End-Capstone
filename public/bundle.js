...
let startDate;
let endDate; // TODO: set interval for container width monitoring
  ...
  buildFieldHeatmap(shots) {
    ...
    if (intervalId !== undefined) {
      ...
      intervalId = setInterval(function () {
        heatmapData.getActiveOffsets(fieldContainer, initialWidth, fieldHeatmapInstance, shots);
      }, 500);
    } else {
      intervalId = setInterval(function () {
        heatmapData.getActiveOffsets(fieldContainer, initialWidth, fieldHeatmapInstance, shots);
